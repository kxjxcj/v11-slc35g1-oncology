...
Notices:
- You do not have to comply with the Public License for elements of the
...
- manuscript/    (v10 final paper + supplementary + tables)
- figures/       (81 PNG figures + 8 v11 new figures)
- peer_review/   (3-reviewer audit + remediation)

Source code is licensed separately under Apache-2.0 (see LICENSE).
Datasets retain their original public-database licences (see data/README.md).